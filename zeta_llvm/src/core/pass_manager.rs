...
impl PassManager {
    ...
    pub fn run(&mut self, module: &mut Module) -> bool {
        unsafe {
            LLVMRunPassManager(self.to_ref(), module.to_ref()) > 0
        }
    }
}
...
impl FunctionPassManager {
    ...
    pub fn initialize(&mut self) -> bool {
        unsafe {
            LLVMInitializeFunctionPassManager(self.to_ref()) > 0
        }
    }

    pub fn run(&mut self, function: &mut dyn Function) -> bool {
        unsafe {
            LLVMRunFunctionPassManager(self.to_ref(), function.to_ref()) > 0
        }
    }

    pub fn finalize(&mut self) -> bool {
        unsafe {
            LLVMFinalizeFunctionPassManager(self.to_ref()) > 0
        }
    }
    ...
    pub fn add_aggressive_DCE_pass(&mut self) {
        unsafe {
            LLVMAddAggressiveDCEPass(self.to_ref())
        }
    }

    pub fn add_alignment_from_assumptions_pass(&mut self) {
        unsafe {
            LLVMAddAlignmentFromAssumptionsPass(self.to_ref())
        }
    }
    ...
    pub fn add_CFG_simplification_pass(&mut self) {
        unsafe {
            LLVMAddCFGSimplificationPass(self.to_ref())
        }
    }

    pub fn add_dead_store_elimination_pass(&mut self) {
        unsafe {
            LLVMAddDeadStoreEliminationPass(self.to_ref())
        }
    }

    pub fn add_scalarizer_pass(&mut self) {
        unsafe {
            LLVMAddScalarizerPass(self.to_ref())
        }
    }

    pub fn add_merged_load_store_motion_pass(&mut self) {
        unsafe {
            LLVMAddMergedLoadStoreMotionPass(self.to_ref())
        }
    }
    ...
    pub fn add_GVN_pass(&mut self) {
        unsafe {
            LLVMAddGVNPass(self.to_ref())
        }
    }

    pub fn add_ind_var_simplify_pass(&mut self) {
        unsafe {
            LLVMAddIndVarSimplifyPass(self.to_ref())
        }
    }

    pub fn add_instruction_combining_pass(&mut self) {
        unsafe {
            LLVMAddInstructionCombiningPass(self.to_ref())
        }
    }

    pub fn add_jump_threading_pass(&mut self) {
        unsafe {
            LLVMAddJumpThreadingPass(self.to_ref())
        }
    }
    ...
    pub fn add_SCCP_pass(&mut self) {
        unsafe {
            LLVMAddSCCPPass(self.to_ref())
        }
    }

    pub fn add_scalar_repl_aggregates_pass(&mut self) {
        unsafe {
            LLVMAddScalarReplAggregatesPass(self.to_ref())
        }
    }
    ...
    pub fn add_scalar_repl_aggregates_pass_SSA(&mut self) {
        unsafe {
            LLVMAddScalarReplAggregatesPassSSA(self.to_ref())
        }
    }

    pub fn add_scalar_repl_aggregates_pass_with_threshold(&mut self, threshold: c_int) {
        unsafe {
            LLVMAddScalarReplAggregatesPassWithThreshold(self.to_ref(), threshold)
        }
    }

    pub fn add_simplify_lib_calls_pass(&mut self) {
        unsafe {
            LLVMAddSimplifyLibCallsPass(self.to_ref())
        }
    }

    pub fn add_tail_call_elimination_pass(&mut self) {
        unsafe {
            LLVMAddTailCallEliminationPass(self.to_ref())
        }
    }

    pub fn add_constant_propagation_pass(&mut self) {
        unsafe {
            LLVMAddConstantPropagationPass(self.to_ref())
        }
    }

    pub fn add_demote_memory_to_register_pass(&mut self) {
        unsafe {
            LLVMAddDemoteMemoryToRegisterPass(self.to_ref())
        }
    }

    pub fn add_verifier_pass(&mut self) {
        unsafe {
            LLVMAddVerifierPass(self.to_ref())
        }
    }

    pub fn add_correlated_value_propagation_pass(&mut self) {
        unsafe {
            LLVMAddCorrelatedValuePropagationPass(self.to_ref())
        }
    }
    ...
    pub fn add_early_CSE_pass(&mut self) {
        unsafe {
            LLVMAddEarlyCSEPass(self.to_ref())
        }
    }

    pub fn add_lower_expect_intrinsic_pass(&mut self) {
        unsafe {
            LLVMAddLowerExpectIntrinsicPass(self.to_ref())
        }
    }

    pub fn add_type_based_alias_analysis_pass(&mut self) {
        unsafe {
            LLVMAddTypeBasedAliasAnalysisPass(self.to_ref())
        }
    }
    ...
    pub fn add_scoped_no_alias_AA_pass(&mut self) {
        unsafe {
            LLVMAddScopedNoAliasAAPass(self.to_ref())
        }
    }

    pub fn add_basic_alias_analysis_pass(&mut self) {
        unsafe {
            LLVMAddBasicAliasAnalysisPass(self.to_ref())
        }
    }
}
